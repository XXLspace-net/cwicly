...
class Cwicly_Plugin_Updater {
	...
	/**
	 * Whether to override WordPress.org plugin updates.
	 *
	 * @var bool
	 */
	...
	/**
	 * Whether to force check for updates transient.
	 *
	 * @var bool
	 */
	private $beta = false;
	 ...
	 * @return object $_data The filtered data
	 */
	 ...
	 * @since 3.6.5
	 *
	 * @param stdClass $data The array data.
	 *
	 * @return array
	 */
	...
	private function verify_ssl() {
		...
		return (bool) apply_filters( 'edd_sl_api_request_verify_ssl', $verify_ssl, $this );
	}
